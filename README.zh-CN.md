...
|:---:|:---:|
| <img src="frontend-draft/uploads/PromptPanel-panel-default.png" alt="PromptPanel 快捷面板：macOS 上的全局快捷键 AI Prompt 启动器，支持搜索、置顶与项目过滤，适用于 ChatGPT、Claude、Cursor" width="380"/> | <img src="frontend-draft/uploads/PromptPanel-library.png" alt="PromptPanel 库管理：本地优先 macOS Prompt 管理器，支持项目、词条编辑、置顶与按词条使用次数排序" width="380"/> |
| 紧凑模式 — 浮在任意编辑器上方 | 设置 — 快捷键、粘贴、主题、备份、运行健康 |
| <img src="frontend-draft/uploads/PromptPanel-panel-min.png" alt="PromptPanel 紧凑面板：键盘优先的 Prompt 选择器，浮在代码编辑器上方" width="380"/> | <img src="frontend-draft/uploads/PromptPanel-settings.png" alt="PromptPanel 设置：全局快捷键、辅助功能权限状态、Sparkle 自动更新、数据库位置、备份与运行健康" width="380"/> |
